...
// Подключаем тут, а не в try потому что node-canvas может быть не установлен
var hello = require('./nodes/hello-world')
...
function plugin() {
  return function(style){
    ...
    // Определяем тут а не выше, чтобы не зависеть от наличия node-canvas
    style.define('hello-world', hello);
  }
}
